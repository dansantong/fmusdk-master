...
if defined VS150COMNTOOLS (call "%VS150COMNTOOLS%\vcvarsall.bat" x86_amd64) else ^
...
pushd co_simulation
cl %SRC% %INC% %OPTIONS% /Fefmusim_cs.exe /link libexpatMT.lib zlog.lib /LIBPATH:..\shared\parser\%FMI_PLATFORM%
del *.obj
popd
