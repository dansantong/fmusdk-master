...
:after_loop
if %SIM_TYPE%==me10 (fmu10\bin\win64\fmusim_me.exe %SIM_OPTIONS%
) else (if %SIM_TYPE%==cs10 (fmu10\bin\win64\fmusim_cs.exe %SIM_OPTIONS%
) else (if %SIM_TYPE%==me20 (fmu20\bin\win64\fmusim_me.exe %SIM_OPTIONS%
) else (if %SIM_TYPE%==cs20 (fmu20\bin\win64\fmusim_cs.exe %SIM_OPTIONS%
